...
/**
 * Similar to a {@link SequentialCommandGroup}, but with some additional helpers.
 */
public class SequentialCommandGroupExtended extends SequentialCommandGroup {
    /**
     * Adds an {@link InstantCommand} from the given procedure and subsystem requirements.
