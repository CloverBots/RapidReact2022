...
public class TestShooterNeoSubsystem extends SubsystemBase {
    ...
    private final CANSparkMax shooterLeadMotor = new CANSparkMax(Ids.TEST_SHOOTER_LEAD_DEVICE, MotorType.kBrushless);
    private final CANSparkMax shooterFollowMotor1 = new CANSparkMax(Ids.TEST_SHOOTER_FOLLOW_DEVICE_1, MotorType.kBrushless);
    ...
    /** Creates a new TestShooterNeoSubsystem. */
    public TestShooterNeoSubsystem() {
